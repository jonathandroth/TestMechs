...
always-takers (or never-takers) that are affected by treatment. Each function can be adjusted for conditional 
random assignment by providing a reg_formula if needed (e.g., adding baseline covariates or instruments).
While this
